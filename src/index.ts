...
import { convert, convertFlags } from "./libs/utils.ts";
...
const flags = flags_usage.processFlags(Deno.args, options) as convertFlags;

if (flags._[0] === undefined || flags._[1] === undefined) {
